...
from .models import Usuario, Turno, DiasDisponibles, HorarioDisponible, HistorialPaciente, ImagenHistorial
...
class HistorialPacienteAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        ...
        return qs.select_related('paciente').order_by('-fecha')
    
    def changelist_view(self, request, extra_context=None):
        response = super().changelist_view(request, extra_context)
        if hasattr(response, 'context_data'):
            response.context_data['title'] = 'Historial de Pacientes'
        return response
...
class DiasDisponiblesAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        extra_context['title'] = 'Días Disponibles'
